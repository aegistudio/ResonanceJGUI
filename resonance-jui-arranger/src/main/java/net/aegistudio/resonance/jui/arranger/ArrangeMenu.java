...
public class ArrangeMenu extends JPopupMenu{
	...
	public ArrangeMenu(MainControl main, final ArrangerModel arrangerModel) {
		...
		main.getTheme().configure(newInstrumentChannel, "channel.midi");
		...
		main.getTheme().configure(newAudioChannel, "channel.audio");
		this.add(newAudioChannel);
		
		newAutomation = new JMenuItem("Create Automation");
		main.getTheme().configure(newAutomation, "channel.automation");
		this.add(newAutomation);
		
		this.add(new JSeparator());
		
		eraseChannel = new JMenuItem("Erase Current Channel");
		main.getTheme().configure(eraseChannel, "common.erase");
