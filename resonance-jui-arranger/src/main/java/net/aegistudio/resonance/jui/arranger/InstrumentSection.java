...
public class InstrumentSection extends ChannelSection {
	...
	public InstrumentSection(MainControl main, ArrangerModel model, String channelName, MidiChannel channel) {
		super(main, model, channelName, channel);
		main.getTheme().configure(
