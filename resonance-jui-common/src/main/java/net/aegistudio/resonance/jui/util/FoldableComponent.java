...
public class FoldableComponent extends Container {
	...
	public ImageIcon pack, unpack;
	
	public FoldableComponent(Theme theme, Component foldingObject) {
		pack = theme.rawIcon("common.pack");
		unpack = theme.rawIcon("common.unpack");
